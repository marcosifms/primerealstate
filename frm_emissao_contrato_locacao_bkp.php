            ...
            <form name="cadastro" id="cadastro" role="form" method="post" action="relatorio_contrato.php" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group col-xs-12">
                  ...
                  <textarea class="textarea" name="texto_contrato" style="width: 100%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" rows="15">
                    ...
                    <p>
                      <strong>Habitación: </strong><?php echo $quartos_imovel;?><br>
                      <strong>Sala: </strong><?php echo $salas_imovel;?><br>
                      <strong>Baño Social: </strong><?php echo $banheiros_imovel;?><br>
                    ...
                    <div style="text-align: right;">
                     ...
                     <p class="lead">
                      ...
                      --------------------------------------------------------------<br><strong>LOCADORA<br>COMPAÑÍA FORTUNA S.A.</strong>
                      <br><br><br><br>
