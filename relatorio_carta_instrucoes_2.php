...
$resultado1 = mysqli_query($con,"SELECT * FROM carta_instrucoes where contrato_carta = '$id_contrato'");
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          <div align="center"><h3><strong>PAGARE Y CARTA DE INSTRUCCIONES</strong></h3></div>
          <br>
