          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                     <?php 
                        ...
                        $sqlcarta1 = mysqli_query($con, "select * from carta_instrucoes");
                        $linhas = mysqli_num_rows($sqlcarta1);
                    ...
                    <button type="button" class="btn btn-info btn-xs" title="Pagare y Carta de Instruções" data-toggle="modal" data-target="#modalcartainstrucoes<?php echo $array['id_contrato'];?>" <?php echo $disabled; ?>><i class="fa fa-file-text-o"></i></button>                   
                  ...
                  <td>
                      <div align="center" class="btn-group">
                          <a href="gerenciar_recibos_inquilino.php?id=<?php echo $array['id_contrato'];?>"><button type="button" class="btn btn-info btn-xs" title="Recibo Dinero - Inquilino"><i class="fa fa-arrow-circle-down"></i></button></a>                    
                      </div>
                  ...
                  <td>
                      <div align="center" class="btn-group">
                          <a href="gerenciar_recibos_proprietario.php?id=<?php echo $array['id_contrato'];?>"><button type="button" class="btn btn-warning btn-xs" title="Recibo Dinero - Proprietario"><i class="fa  fa-arrow-circle-up"></i></button></a>                    
                      </div>
                ...
                <div class="modal fade" id="modalalterauser<?php echo $array['id_contrato'];?>" role="dialog" aria-labelledby="exampleModalLabel">
                            ...
                            <form name="alterar_cadastro" id="alterar_cadastro" role="form" method="post" action="src/altera_contrato.php" enctype="multipart/form-data">
                              <div class="box-body">
                                ...
                                <label for="cliente_contrato">Cliente</label>
                                    <select class="form-control select2" style="width: 100%;"  name="cliente_contrato" id="cliente_contrato" required>
                              ...
                              <div class="form-group col-md-6">
                                <label for="tipo_contrato">Tipo de contrato</label>
                                    <select class="form-control select2" style="width: 100%;"  name="tipo_contrato" id="tipo_contrato" required>
                              ...
                              <div class="form-group col-md-6">
                                <label for="cliente_locatario">Locatario/Comprador</label>
                                    ...
                                    <select class="form-control select2" style="width: 100%;"  name="cliente_locatario" id="cliente_locatario" required>
                              ...
                              <div class="form-group col-md-3">
                                <label for="data_contrato">Fecha Contrato </label>
                                <input type="date" class="form-control" id="data_contrato" name="data_contrato" value="<?php print $array['data_contrato'];?>" required>
                              </div>
                    ...
                    <div class="modal fade" id="modalcartainstrucoes<?php echo $array['id_contrato'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                      ...
                      <div class= "modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title">Pagare y Carta de Instruções </h4>
                          </div>
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row">
                              ...
                              <?php 
                                ...
                                $sqlcarta = mysqli_query($con, "select * from carta_instrucoes");
                                  while($row=mysqli_fetch_array($sqlcarta)){ 
                              ?>

                              <div class="col-lg-6"><strong>Fecha de generación de la carta</strong>: <?php echo databr($row['data_geracao_carta_instrucoes']);?></div>
                              <div class="col-lg-6"><a href="relatorio_carta_instrucoes.php?id=<?php echo $row['id_carta_instrucoes'];?>">Ver carta</a></div>
                            ...
                            <div class="box-body">
                             ...
                             <div class="form-group col-md-6">
                                <label for="cliente_contrato">Cliente</label>
                                    ...
                                    <select class="form-control select2" style="width: 100%;"  name="cliente_contrato" id="cliente_contrato" onchange="carregadata();" required>
