              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                   ...
                   <td>
                      <a href="relatorio_recibo_pagamento_inquilino.php?idrecibo=<?php echo $array['id_recibo_pagamento'];?>?idcontrato=<?php echo $id_contrato;?>"><button type="button" class="btn btn-info btn-xs" title="impresión recibo"><i class="fa fa-print"></i></button></a>                   
                      </div>
