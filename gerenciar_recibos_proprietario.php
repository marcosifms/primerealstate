...
<style>
  ...
  <section class="content-header">
       <h1>
        Recibos de Pagamento - Proprietario         
      </h1>
  </section>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
        					$query = mysqli_query($con,"select * from recibo_pagamento_inquilino where contrato_pagamento = '$id_contrato' and tipo_recibo = '2'");
                ...
                <tr>
                  ...
                  <td>
                      <div align="center" class="btn-group">
                      		<a href="frm_pagamento_aluguel_inquilino.php?idrecibo=<?php echo $array['id_recibo_pagamento'];?>?idcontrato=<?php echo $id_contrato;?>"><button type="button" class="btn btn-info btn-xs" title="Incluir artículos en el recibo"><i class="fa fa-plus-square-o"></i></button></a>                 
                      </div>

                  </td>

                   <td>
                      <a href="relatorio_recibo_pagamento_proprietario.php?idrecibo=<?php echo $array['id_recibo_pagamento'];?>?idcontrato=<?php echo $id_contrato;?>"><button type="button" class="btn btn-info btn-xs" title="impresión recibo"><i class="fa fa-print"></i></button></a>                   
                      </div>
    ...
    <script type="text/javascript">
      jQuery(document).ready(function(){
        ...
        jQuery('#cadastro').submit(function(){
          ...
          jQuery.ajax({
            type: "POST",
            url: "src/grava_recibo_proprietario.php",
            data: dados,
