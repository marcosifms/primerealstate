    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          ...
          <p class="lead">Por medio del presente documento <strong><?php echo $nome_cliente; ?></strong>, RG/C.I. nº <strong><?php echo $rg_ci_cliente_locatario;?></strong>, declara haber recibido de:</p>

          <p class="lead"><strong>Nombre: </strong>COMPAÑÍA FORTUNA S.A., <strong>RG/C.I.: </strong>********, <strong>CPF/RUC: </strong>801.055.41-5, <strong>Domicilio: </strong>TENIENTE HERRERO, 3470, <strong>Barrío: </strong>SAN ANTONIO, <strong>Ciudad: </strong>PEDRO JUAN CABALLERO, <strong>Departamento: </strong>AMAMBAY.</p>
          ...
          <div class="col-md-12">
              <div class="col-md-6">
               <p class="lead"><?php echo $nome_cliente; ?><br>RG/C.I. nº <?php echo $rg_ci_cliente_locatario;?></p>
              </div>
